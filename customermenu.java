...
public class customermenu extends JFrame {
	...
	public customermenu() throws Throwable {
		...
		lbl.setFont(new Font("Arial Narrow", Font.BOLD | Font.ITALIC, 24));
		...
		btnRecharge.addActionListener(new ActionListener() {
			publicvoid actionPerformed(ActionEvent e) {
				...
				p=con.prepareStatement("select * from details WHERE userid=?");
					p.setString(1, user1);
					...
					intda=Integer.parseInt(rs.getString("dueamount"));
					intrech1=Integer.parseInt(rech);
					intdue=da-rech1;
		...
		p=con.prepareStatement("update details set dueamount=? where userid=?");
...
Class.forName("com.mysql.cj.jdbc.Driver");
			...
			int a;
		    insert=con2.prepareStatement("select * from details WHERE userid=?");
			...
			while(rs.next()) {
				...
				// info page Auto-generated catch block
				e1.printStackTrace();
